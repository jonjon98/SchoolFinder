...
class SchoolList2 extends StatelessWidget {
  ...
  final Login_info lg;
  SchoolList2({Key key,this.lg}) : super(key:key);
  ...
  Widget build(BuildContext context) {
     Login_info lg1=ModalRoute.of(context).settings.arguments;
    if(lg1!=null)
      {
        checklogin=true;
    ...
    Future<List<Schools>> allSchools = fetchSchools();
    return Scaffold(
      appBar: AppBar(
                      ...
                      child: Column(
                        children: <Widget>[
                          ListTile(
                            ...
                            subtitle: Text(snapshot.data[index].zoneCode),
                          )
                        ],
                      ),
                    );
    ...
    return ListView.builder(
      itemBuilder: (context, index) =>
          ...
          ListTile(
            onTap: (){
              Navigator.pushNamed(context, '/Moreinfo',
                arguments: More_info(username,pass,suggestionList[index]));
              },
